...
export default function App() {
  ...
  }, [birdBottom, obstaclesLeft, obstaclesNegHeight, obstaclesLeftTwo, obstaclesNegHeightTwo, isGameOver                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ]);

  return (
    <TouchableWithoutFeedback onPress={() => setBirdBottom((b) => b + 50)}>
    <View style={styles.container}>
      <Text style={styles.sore}>{score}</Text>
